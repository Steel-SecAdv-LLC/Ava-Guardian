...
def verify_crypto_package(
    ...
    # 2. Verify HMAC
    results["hmac"] = hmac_verify(
        computed_hash,
        bytes.fromhex(package.hmac_tag),
        hmac_key
    )
...
def main():
    ...
    print(f"  ✓ Master secret: 256 bits")
    print(f"  ✓ HMAC key: 256 bits")
